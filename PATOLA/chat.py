...
def chatbot(faq):
    print("PATOLA: Olá! Sou seu assistente virtual. Pergunte algo ou diga 'sair' para encerrar.")
    while True:
        entrada_usuario = input("Você: ").strip()
        if entrada_usuario.lower() in ["sair", "tchau", "adeus"]:
            print("PATOLA: Até logo! Espero ter ajudado.")
            break
        elif entrada_usuario in faq:
            print(f"PATOLA: {faq[entrada_usuario]}")
            ...
            if "abra o youtube" in comando:
                ...
                print("PATOLA: Não consegui identificar o site. Tente novamente.")
                falar("Não consegui identificar o site. Tente novamente.")
        else:
            print("PATOLA: Hmm, eu ainda não sei responder isso. Você pode me ensinar?")
            treinar_bot(faq)
